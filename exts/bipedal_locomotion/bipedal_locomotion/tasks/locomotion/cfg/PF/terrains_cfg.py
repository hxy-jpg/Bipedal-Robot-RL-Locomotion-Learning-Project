...
STAIRS_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "hf_pyramid_slope": HfPyramidSlopedTerrainCfg(
            proportion=0.5, 
            slope_range=(0.0, 0.3),            # 斜率范围 0-40% / Slope range 0-40%
            platform_width=2.0, 
            border_width=0.25
        ),
...
STAIRS_TERRAINS_PLAY_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "boxes": MeshRandomGridTerrainCfg(
            proportion=0.00,                 # 20%占比 / 20% proportion
            grid_width=0.33,                # 更大的格子 / Larger grid
            grid_height_range=(0.01, 0.04), 
            platform_width=2.0
        ),
        "random_rough": HfRandomUniformTerrainCfg(
            proportion=0.33,                # 34%占比 / 34% proportion
            noise_range=(0.01, 0.06), 
            noise_step=0.01, 
            border_width=0.25
        ),
        ...
        "hf_pyramid_slope": HfPyramidSlopedTerrainCfg(
            proportion=0.34, slope_range=(0.0, 0.3), platform_width=2.0, border_width=0.25
        ),
        "hf_pyramid_slope_inv": HfInvertedPyramidSlopedTerrainCfg(
